    ...
    <div class="container py-4 d-flex align-middle justify-content-center mt-6">
        ...
        <div class="d-flex justify-content-center align-middle">
            <div class="card card-plain bg-light">
                ...
                <div class="card-body">
                    <form role="form" action="{{route('registerstore')}}" method="post">
                        @csrf
                        <div class="mb-3">
                            <input type="text" name="name"
                                class="form-control form-control-lg"
                                placeholder="Name" aria-label="Email" required
                                value="{{ old('email') }}">
                            @error('email')
                        ...
                        <div class="mb-3">
                            <input type="text" name="password" for="password"
                                class="form-control form-control-lg"
                        ...
                        <div class="text-center">
                            <button type="sumbit"
                                class="btn btn-lg bg-gradient-primary w-100 mt-4 mb-0">Sign up</button>
                        </div>
                    </form>
                </div>
